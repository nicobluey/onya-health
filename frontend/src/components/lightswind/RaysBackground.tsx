...
const RaysBackground: React.FC<RaysBackgroundProps> = ({
    ...
    return (
        ...
        `}
            ...
            <div
                className="absolute left-0 right-0 mx-auto h-full w-full overflow-hidden pointer-events-none"
                style={{
                    maxWidth: '45%',
                    top: '-50%',
                ...
                >
                    <div
                        style={{
                            ...
                            animation: animated ? `rotate-cw ${10 / animationSpeed}s linear infinite` : 'none',
                            background: `
                conic-gradient(
                  from 20deg at 50% 50%,
              ...
              `,
                    ...
                    <div
                        style={{
                            ...
                            opacity: 0.45,
                            willChange: 'transform',
                            animation: animated ? `rotate-ccw ${6 / animationSpeed}s linear infinite` : 'none',
                            background: `
                conic-gradient(
                  from 0deg at 50% 50%,
                  rgba(3, 10, 0, 0.5), transparent,
                ...
                >
                    <div
                        style={{
                            ...
                            left: 0,
                            willChange: 'transform',
                            animation: animated ? `rotate-ccw ${8 / animationSpeed}s linear infinite` : 'none',
                ...
                ${colors.purple}
                    ...
                    <div
                        style={{
                            ...
                            left: 0,
                            willChange: 'transform',
                            animation: animated ? `rotate-ccw ${80 / animationSpeed}s linear infinite` : 'none',
                            WebkitMaskImage:
