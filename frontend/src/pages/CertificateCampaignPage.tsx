...
const LANDING_CONFIGS: Record<string, LandingConfig> = {
    '/medical-certificate-work': {
        ...
        metaDescription:
            'Work medical certificate requests start at $9.17 for 1 day, then linearly scale up to $29.71 for 5-7 days with Australian doctor review.',
    ...
    '/medical-certificate-university': {
        ...
        metaDescription:
            'University medical certificate requests start at $9.17 for 1 day, then linearly scale up to $29.71 for 5-7 days with doctor review.',
    ...
    '/medical-certificate-carers-leave': {
        ...
        metaDescription:
            "Carer's leave certificate requests start at $9.17 for 1 day, then linearly scale up to $29.71 for 5-7 days with Australian doctor review.",
            ...
            <div className="onya-section mx-auto w-full max-w-6xl px-4 md:px-6">
                <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                    ...
                    <p className="max-w-xl text-sm leading-relaxed text-text-secondary md:text-base">
                        1-day requests start at $9.17. Longer requests are priced clearly before payment, capped at $29.71 for 5-7 days, or choose All Access at $19/month.
                    </p>
                </div>
